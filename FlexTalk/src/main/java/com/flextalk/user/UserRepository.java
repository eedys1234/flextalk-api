...
public interface UserRepository extends JpaRepository<User, Long>{
	...
	@Query("SELECT count(u) FROM User u WHERE u.userId = :user_id and u.userPw = :user_pw")
	public Long findByUserIdAndUserPw(@Param("user_id") String user_id, @Param("user_pw") String user_pw);
